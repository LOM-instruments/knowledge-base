...
* Recorder **well above ~4 kΩ** — Sound Devices MixPre series (~4 kΩ), Sound Devices 7xx series (~7.5 kΩ) or a high-impedance interface — means the element is under-damped and you're a **good candidate**.
