...
* Recorder **well above ~4 kΩ** — Sound Devices MixPre series (~4 kΩ), Sound Devices 7xx series (~7.5 kΩ), Sonosax SX-R4/SX-M2D2 (~5.7 kΩ) or a high-impedance interface — means the element is under-damped and you're a **good candidate**.
