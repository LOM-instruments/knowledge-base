...
1.  ![](../images/geofon_diy_kit-1_large.jpeg)

    Examine the package and check if you have all the necessary components and tools (see the lists above).

2.  ![](../images/geofon_diy_kit-2_large.jpeg)

    Unpack the XLR connector and the small piece heat-shrink tubing from the tube. Identify the cable end with three conductors. Slide the XLR boot onto the cable (if you forget, you may need to desolder the connector later) and the small piece of heat-shrink tubing onto the exposed twisted conductor without insulation—this is the cable's shielding.

3.  ![](../images/geofon_diy_kit-3_large.jpeg)

    Tin the exposed conductors on the cable with a bit of solder. Check the XLR connector — you'll notice it has small number markings. Solder the exposed conductor with heat-shrink tubing to pin number 1, the brown conductor to pin 2, and the white conductor to pin 3.
...
4.  ![](../images/geofon_diy_kit-4_large.jpeg)

    Assemble to connector. If you need help, refer to [the manual by its manufacturer.](https://www.neutrik.com/media/8050/download/xlr-xx-series.pdf?v=1)

    *Technical note: We use gold-plated connectors for better performance in outdoor conditions.*

5.  ![](../images/geofon_diy_kit-5_large.jpeg)

    Unscrew the Geofón body parts apart and remove the Geofón element from inside.

    Note: newer version of the Geofón body may have threads swapped between top and bottom part, compared to the picture.

6.  ![](../images/geofon_diy_kit-6_large.jpeg)

    Pull the unused cable end through the cable gland on the top part of the Geofón body. Do not tighten the gland yet!

7.  ![](../images/geofon_diy_kit-7_large.jpeg)

    Tin the exposed conductors on the cable with a bit of solder. Solder the conductors to the pins on the element. Brown conductor should be connected to the pin with a dot next to it. Solder as fast as possible, one joint shouldn't take longer then 2-4 seconds (depending on your soldering iron).
...
9.  ![](../images/geofon_diy_kit-9_large.jpeg)

    Screw the bottom part of the Geofón body onto the top part. Tighten the cable gland on top of the top part of the Geofón body as tightly as possible by hand. If necessary (cable is slipping), use a 14 mm wrench. Do not overtighten the gland.
...
10. ![](../images/geofon_diy_kit-10_large.jpeg)

    Your Geofón is ready for the vibrations of the world!
