...
**Repairs.** Before sending anything back, [contact us](https://store.lom.audio) with a description of the problem and your proof of purchase — many issues can be resolved without shipping.
...
**Manufacturer:** LOM s.r.o., Jelenia 10, 811 05 Bratislava, Slovakia · [store.lom.audio](https://store.lom.audio)
