...
<div class="pd">
  <div class="pd-gallery">
    <img src="../../images/ucho_pro.jpg" alt="Ucho Pro">
  </div>
  <div class="pd-info">
    <h1>Ucho Pro</h1>
    ...
    <div class="body">
Single phantom-powered omnidirectional electret microphone with professional balanced XLR output. The Ucho Pro uses the same high-quality ⌀13 mm capsule and active electronics as the Uši Pro stereo pair, sold individually for mono recording applications or as a replacement and expansion unit. Ideal for specialized recording setups and professional audio workflows.
    </div>
    <div class="credits">
      <div><span class="key">In the box:</span> 1× Ucho Pro microphone, 1× active XLR-miniXLR cable (1.5 m), 1× microphone clip</div>
    </div>
  </div>
</div>
...
!!! danger "Use only LOM cables"
    ...
    Never use third-party mini-XLR cables with Ucho Pro. The included cable contains circuitry that converts phantom power to the voltage the capsule expects — **connecting a plain cable while phantom power is on may permanently damage the microphone**, and such damage is not covered by the warranty.
...
- Compact ⌀13 mm capsule
- Exceptionally low self-noise (~14 dBA)
- Low output impedance (30–50 Ω)
- Compatible with all Uši series accessories
...
Ucho Pro needs one XLR microphone input with **phantom power** (24–48 V, IEC 61938). Any recorder or preamp with standard 48 V phantom works; if yours has a 24 V mode, it saves battery with identical performance. The microphone draws ~3 mA.
...
For outdoor recording, slip a windbubble over the capsule to reduce wind noise. Match the size to the microphone — see [recommended wind protection](../faq/microphones.md#wind-protection). For extreme winds, we recommend the "Extreme" version.
...
A second Ucho Pro makes an (unmatched) stereo pair; for sensitivity-matched stereo, see [Uši Pro](usi-pro.md). Ucho Pro capsules also work with the Uši (minijack) cable — use only LOM cables (see Important information above).
...
<a class="acc-guide" href="../../images/usi-pro-accessory-guide.png"><img src="../../images/usi-pro-accessory-guide.png" alt="Uši Pro accessory guide"></a>
...
Ucho Pro covers mono duties with the same voice as the Uši Pro pair: spot-miking a single source in the field, plant/lavalier-style placement, mono ambiences, and expanding an existing Uši Pro rig with a third channel. The capsule responds far beyond the audible range (up to ~80 kHz), so with a high-sample-rate recorder it also works for [recording ultrasound](../tips/recording-ultrasound.md). Sources louder than ~122 dB SPL will overload the capsule.
...
- **No sound, or a very quiet signal** → is phantom power actually on, and on the right input? See [no signal](../faq/troubleshooting.md#mic-no-signal).
...
<div class="accessory-card">
<img src="../../images/usi_windbubbles.jpg" alt="">
<div class="accessory-body">
<div class="accessory-title">Uši windbubbles</div>
<div class="accessory-desc">Foam windscreens for wind noise reduction</div>
<div class="accessory-links"><a class="buy" href="https://store.lom.audio/products/usi-windbubbles">Buy</a></div>
</div>
</div>
<div class="accessory-card">
<img src="../../images/usi_windbubbles_pro_extreme_pair.jpg" alt="">
<div class="accessory-body">
<div class="accessory-title">Uši windbubbles Extreme</div>
<div class="accessory-desc">Advanced wind protection for extreme conditions</div>
<div class="accessory-links"><a class="buy" href="https://store.lom.audio/products/usi-windbubbles-extreme">Buy</a></div>
</div>
</div>
</div>
