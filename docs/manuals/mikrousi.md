...
<div class="pd">
  <div class="pd-gallery">
    <img src="../../images/mikrousi_v2.jpg" alt="mikroUši">
  </div>
  <div class="pd-info">
    <h1>mikroUši</h1>
...
The mikroUši clip is designed to be used together with wind protection: insert the microphone cable into the groove, then gently pull the microphone into the designated "cup". See [more mounting ideas](../tips/mounting-usi.md).

**Using the wind protection — mikroUši windbubbles** *(optional accessory)*
...
<a class="acc-guide" href="../../images/mikrousi-accessory-guide.png"><img src="../../images/mikrousi-accessory-guide.png" alt="mikroUši accessory guide"></a>
...
mikroUši is the choice when the microphone must disappear: covert and discreet field recording, location sound on actors and instruments, tight spaces where nothing larger fits, and wearable stereo rigs. The tiny capsule keeps its response far beyond the audible range (up to ~80 kHz), making it a favorite for [recording ultrasound](../tips/recording-ultrasound.md) — bats, electronics, rodents. For very quiet nature ambiences, the larger [Uši](usi.md) has a lower noise floor (~14 vs ~20 dBA); sources above ~115 dB SPL will overload the capsule — see the [comparison table](usi-comparison.md).
...
![](../images/mikrousi_with_clips.jpg)
