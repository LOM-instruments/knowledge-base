...
<div class="pd">
  <div class="pd-gallery">
    <img src="../../images/usi_pro.jpg" alt="Uši Pro">
  </div>
  <div class="pd-info">
    <h1>Uši Pro</h1>
...
Matched stereo pair of phantom-powered, high-quality omnidirectional electret microphones with professional balanced XLR output. Built on the same compact ⌀13 mm capsule as the Uši, the Pro version features active electronics for low-impedance balanced output, making it ideal for professional field recorders and preamplifiers. The modular design supports cable swapping for maximum flexibility.
    ...
    <div class="credits">
      <div><span class="key">In the box:</span> 2× Uši Pro microphones, 1× Uši Pro (XLR) cable, 2× microphone clips</div>
    </div>
  </div>
</div>
...
The system is fully modular: Uši Pro capsules also work with the Uši (minijack) cable, and standard Uši capsules work with this XLR cable — just swap. Use only LOM cables (see the safety notes above).
