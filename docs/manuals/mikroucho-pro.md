...
<div class="pd">
  <div class="pd-gallery">
    <img src="../../images/mikroucho_pro.jpg" alt="mikroUcho Pro">
  </div>
  <div class="pd-info">
    <h1>mikroUcho Pro</h1>
...
mikroUcho Pro is the mono workhorse for placements where the microphone must vanish: hidden spot mics on sets, instruments and props, plant microphones in documentary work, and expanding a mikroUši Pro rig with an extra channel. The capsule responds far beyond the audible range (up to ~80 kHz), so it also suits [recording ultrasound](../tips/recording-ultrasound.md). Sources above ~115 dB SPL will overload the capsule — see the [comparison table](usi-comparison.md).
