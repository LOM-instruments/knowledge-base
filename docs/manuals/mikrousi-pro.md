...
<div class="pd">
  <div class="pd-gallery">
    <img src="../../images/mikrousi_pro.jpg" alt="mikroUši Pro">
  </div>
  <div class="pd-info">
    <h1>mikroUši Pro</h1>
...
mikroUši Pro pairs maximum concealment with professional balanced connections: location sound on actors and instruments, discreet documentary stereo, tight spaces where nothing larger fits — all running into standard XLR preamps over long cable runs without noise pickup. The tiny capsule keeps its response far beyond the audible range (up to ~80 kHz), so it also suits [recording ultrasound](../tips/recording-ultrasound.md). For very quiet nature ambiences, the larger [Uši Pro](usi-pro.md) has a lower noise floor (~14 vs ~20 dBA); sources above ~115 dB SPL will overload the capsule — see the [comparison table](usi-comparison.md).
